    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .vok-group { flex: 0 0 auto; min-height: 84px; display: flex; gap: 10px; border: 1.5px solid #0b1f4d; border-radius: 7px; overflow: hidden; background: #fff; }
            ...
            .vok-photo {
                ...
                border: 1.5px solid #0b1f4d; background: #eef1f6;
